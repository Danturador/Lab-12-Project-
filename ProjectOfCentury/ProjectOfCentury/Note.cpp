	...
	do {
		...
		switch (choiceOfOperation) {
			...
			case '3':
				...
				break;
			default:
				printf("\033[1;32mТакой операции нет!\033[0m");
				break;
		}
...
int ChooseOperation(int operation) {
	...
	do {
		...
		default: break;
		case '1':
			pathForFile = "D:\\One Drive\\OneDrive\\Рабочий стол\\";
			break;
		case '2':
			pathForFile = "D:\\One Drive\\OneDrive\\Документы\\";
			break;
		}
